# -*- coding: utf-8 -*-
#
# DCASE Utilities documentation build configuration file, created by
# sphinx-quickstart on Sun Feb 19 13:45:21 2017.
#
...
copyright = u'2022, Toni Heittola et al.'
...
# of the sidebar.
html_logo = '_images/dcase_util.png'
...
htmlhelp_basename = 'DCASEUtilitiesdoc'
...
latex_documents = [
    (master_doc, 'dcase_util.tex', u'DCASE Utilities Documentation',
     u'Toni Heittola', 'manual'),
]
...
man_pages = [
    (master_doc, 'dcase_util', u'DCASE Utilities Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DCASEUtilities', u'DCASE Utilities Documentation',
     author, 'DCASEUtilities', 'One line description of project.',
     'Miscellaneous'),
]
